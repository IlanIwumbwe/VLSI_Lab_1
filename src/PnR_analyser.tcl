...
set DESIGN analyser  
set VERILOG_FILES [list OUTPUTS/analyser_synth.v]
set SDC_FILE OUTPUTS/analyser_synth.sdc

#Top-level module name
set DESIGN analyser                                  ;# top-level module name            
set VERILOG_FILES [list OUTPUTS/analyser_synth.v]    ;# output synthsis task
set SDC_FILE OUTPUTS/analyser_synth.sdc              ;# specify constraints for PnR
